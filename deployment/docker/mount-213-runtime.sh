...
REMOTE_PATH="${REMOTE_PATH:-/srv/safetyraise-data/runtime}"
LOCAL_PATH="${LOCAL_PATH:-/srv/safetyraise/runtime}"
...
echo "已挂载运行时目录：${REMOTE_USER}@${REMOTE_HOST}:${REMOTE_PORT}:${REMOTE_PATH} -> ${LOCAL_PATH}"
